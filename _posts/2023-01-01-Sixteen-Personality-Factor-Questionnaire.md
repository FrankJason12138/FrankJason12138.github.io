    ...
    <div id="quiz-container">
        ...
        <form id="psychologyTest">
                ...
                <div class="question-group active" id="qg-0">
                    ...
                    <label class="custom-radio"><input type="radio" name="question1" value="1"> (A) 是的</label>
                ...
                <div class="question-group" id="qg-1">
                    <div class="q-counter">题目 2 / 187</div>
                    <div class="question-label">2. 我对本测试的每一个问题，都能做到诚实地回答：</div>
                    <label class="custom-radio"><input type="radio" name="question2" value="1"> (A) 是的</label>
...
<div style="margin-top: 40px; text-align: center; border-top: 1px solid #eee; padding-top: 20px;">
    ...
    <div style="margin-bottom: 20px;">
        <img src="{{ '/assets/icons/alipay-logo.svg' | relative_url }}" alt="支付宝" style="width: 150px;">
    </div>
    <a href="https://shop.dittopsych.xyz/#/3/detail" target="_blank" style="text-decoration: none; color: #006400; font-weight: bold; font-size: 18px;">
        点击前往购买页
    </a>
</div>
