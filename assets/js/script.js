    ...
    var resultTextX3 = "";
    if (scoreX3 <= 4) {
        resultTextX3 = " 情感丰富而感到困扰不安，它可能是缺乏信心，颓丧的类型，对生活中的细节较为含蓄敏感，性格温和，讲究生活艺术，采取行动前再三思考，顾虑太多。";
    } else if (scoreX3 > 4 && scoreX3 < 8) {
        resultTextX3 = " 您的得分显示您在此项上的表现为中等水平，和大部分人一样";
    } else if (scoreX3 >= 8) {
        resultTextX3 = " 富有事业心，果断，刚毅，有进取精神，精力充沛，行动迅速，但常忽视生活上的细节，只对明显的事物注意，有时会考虑不周，不计后果，贸然行事。";
    }
