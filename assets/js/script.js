...
if (differenceI <  -1.5 * standardDeviationI) {
    ...
    resultTextI = "您在此项上得分较高，软心肠、敏感、过爱（慈爱）这些词能够来描述你再好不过，易受感动；通常心肠软，较女性化，这样的才是你；但有时过分不讲实际，易感情用事，缺乏耐心与恒心。爱好艺术，富于幻想，有时过于不务实际；不喜欢接近粗鲁的人和做笨重的工作；在团队活动中，由于常常有不着实际的看法和行为而降低团体的工作效率。";
} else {
