    ...
    var resultTextX1 = "";
    if (scoreX1 <= 4) {
        resultTextX1 = " 您在此项上的得分较低，表明您在生活中容易适应，通常感到心满意足，能做到所期望的及自认为重要的事情。也可能对困难的工作缺乏毅力，有时会出现知难而退，不肯奋斗努力的倾向。";
    ...
    } else if (scoreX2 > 4 && scoreX2 < 8) {
        resultTextX2 = " 您的得分显示您在此项上的表现为中等水平，和大部分人一样,有时内向有时外向。";
    } else if (scoreX2 >= 8) {
    ...
    var resultTextX3 = "";
    if (scoreX3 <= 4) {
        resultTextX3 = " 您在此项上的得分较低，表明您情感丰富而感到困扰不安，它可能是缺乏信心，颓丧的类型，对生活中的细节较为含蓄敏感，性格温和，讲究生活艺术，采取行动前再三思考，顾虑太多。";
    } else if (scoreX3 > 4 && scoreX3 < 8) {
        resultTextX3 = " 您的得分显示您在此项上的表现为中等水平，和大部分人一样";
    } else if (scoreX3 >= 8) {
        resultTextX3 = " 您在此项上的得分较高，这意味着您富有事业心，果断，刚毅，有进取精神，精力充沛，行动迅速，但常忽视生活上的细节，只对明显的事物注意，有时会考虑不周，不计后果，贸然行事。";
    }
    ...
    var scores = [scoreA, scoreB, scoreC, scoreE, scoreF, scoreG, 
        ...
        resultDisplay.style.textAlign = "center";
        <><script src="https://www.paypal.com/sdk/js?client-id=BAARHNfmKzHLXfr68uX0--8arP3l0m-JLplAUepTZZsoSZXXIkhyC4uWP8XjQfCfduITf_zf1cOcrKkwdk&components=hosted-buttons&disable-funding=venmo&currency=USD"></script><div id="paypal-container-3TCTBFSTLV3LU"></div><script>
            paypal.HostedButtons({hostedButtonId}: "3TCTBFSTLV3LU",
            ).render("#paypal-container-3TCTBFSTLV3LU")
        </script></>
